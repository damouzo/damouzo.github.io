...
You can write in plain Markdown: **bold**, _italics_, lists, code blocks...

```bash
nextflow run main.nf -profile docker
```

And that is it. When you want to publish a real post, copy this file, rename it with the new date and title, and edit the content.